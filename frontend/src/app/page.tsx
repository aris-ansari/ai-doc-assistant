      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-6 py-8">
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <Link
              href="/register"
              className="rounded-lg bg-white px-4 py-2 font-medium text-slate-950 hover:bg-slate-100"
            >
              Create account
            </Link>
          </div>
        ...
        <section className="flex flex-1 items-center py-20">
          <div className="max-w-3xl">
            <p className="mb-5 text-sm font-medium uppercase tracking-[0.25em] text-slate-400">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              ...
              <Link
                href="/login"
                className="rounded-xl border border-slate-700 px-5 py-3 font-medium text-white hover:bg-slate-900"
              >
                Sign in
              </Link>
            </div>
