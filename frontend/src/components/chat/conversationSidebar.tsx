    ...
    <aside className="flex min-h-0 w-full flex-col border-b border-slate-200 bg-white lg:w-72 lg:border-b-0 lg:border-r">
      <div className="flex items-center justify-between border-b border-slate-200 p-4">
        ...
        <button
          type="button"
          onClick={onNew}
          className="inline-flex items-center gap-1.5 rounded-lg bg-slate-950 px-2.5 py-2 text-xs font-semibold text-white hover:bg-slate-800"
        >
          <Plus size={14} /> New
        </button>
      </div>
          ...
          conversations.map((conversation) => (
            ...
            >
              ...
              <button
                ...
                className="mr-1 rounded-md p-2 text-slate-400 opacity-0 transition hover:bg-red-50 hover:text-red-600 group-hover:opacity-100 disabled:opacity-50"
              >
                <Trash2 size={14} />
              </button>
            </div>
